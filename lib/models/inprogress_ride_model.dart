...
//
//     final inProgressRideModel = inProgressRideModelFromJson(jsonString);

import 'dart:convert';

InProgressRideModel inProgressRideModelFromJson(String str) => InProgressRideModel.fromJson(json.decode(str));

String inProgressRideModelToJson(InProgressRideModel data) => json.encode(data.toJson());

class InProgressRideModel {
  String? status;
  List<Datum>? data;
  ...
  factory InProgressRideModel.fromJson(Map<String, dynamic> json) => InProgressRideModel(
    status: json["status"],
