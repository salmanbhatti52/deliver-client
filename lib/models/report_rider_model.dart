...
//
//     final reportRiderModel = reportRiderModelFromJson(jsonString);

import 'dart:convert';

ReportRiderModel reportRiderModelFromJson(String str) => ReportRiderModel.fromJson(json.decode(str));

String reportRiderModelToJson(ReportRiderModel data) => json.encode(data.toJson());

class ReportRiderModel {
  String? status;
  Data? data;
  ...
  factory ReportRiderModel.fromJson(Map<String, dynamic> json) => ReportRiderModel(
    status: json["status"],
...
class Data {
  ...
  String? evidenceAudio;
  String? evidenceVideo;
  String? dateAdded;
  BookingsReportsReasons? bookingsReportsReasons;
  Bookings? bookings;

  Data({
    this.bookingsReportsId,
    ...
    this.evidenceVideo,
    this.dateAdded,
    this.bookingsReportsReasons,
    this.bookings,
  });

  factory Data.fromJson(Map<String, dynamic> json) => Data(
    bookingsReportsId: json["bookings_reports_id"],
    ...
    evidenceAudio: json["evidence_audio"],
    evidenceVideo: json["evidence_video"],
    dateAdded: json["date_added"],
    bookingsReportsReasons: BookingsReportsReasons.fromJson(json["bookings_reports_reasons"]),
    bookings: Bookings.fromJson(json["bookings"]),
  );

  Map<String, dynamic> toJson() => {
    "bookings_reports_id": bookingsReportsId,
    ...
    "bookings_reports_reasons": bookingsReportsReasons?.toJson(),
...
class Bookings {
  ...
  factory Bookings.fromJson(Map<String, dynamic> json) => Bookings(
    ...
    bookingsFleet: List<BookingsFleet>.from(json["bookings_fleet"].map((x) => BookingsFleet.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "bookings_fleet": List<dynamic>.from(bookingsFleet!.map((x) => x.toJson())),
...
class BookingsFleet {
  ...
  factory BookingsFleet.fromJson(Map<String, dynamic> json) => BookingsFleet(
    ...
    dateModified: json["date_modified"],
    status: json["status"],
    bookingsDestinations: BookingsDestinations.fromJson(json["bookings_destinations"]),
    vehicles: Vehicles.fromJson(json["vehicles"]),
    usersFleet: json["users_fleet"],
  );
...
class BookingsDestinations {
  ...
  factory BookingsDestinations.fromJson(Map<String, dynamic> json) => BookingsDestinations(
    bookingsDestinationsId: json["bookings_destinations_id"],
    bookingsId: json["bookings_id"],
    ...
    bookingsDestinationsStatus: BookingsDestinationsStatus.fromJson(json["bookings_destinations_status"]),
  );
...
class BookingsDestinationsStatus {
  ...
  factory BookingsDestinationsStatus.fromJson(Map<String, dynamic> json) => BookingsDestinationsStatus(
    bookingsDestinationsStatusId: json["bookings_destinations_status_id"],
    name: json["name"],
    status: json["status"],
  );
...
class BookingsReportsReasons {
  int? bookingsReportsReasonsId;
  String? reason;
  String? status;

  BookingsReportsReasons({
    this.bookingsReportsReasonsId,
    this.reason,
    this.status,
  });

  factory BookingsReportsReasons.fromJson(Map<String, dynamic> json) => BookingsReportsReasons(
    bookingsReportsReasonsId: json["bookings_reports_reasons_id"],
    reason: json["reason"],
    status: json["status"],
  );
