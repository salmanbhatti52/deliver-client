...
//
//     final completedRideModel = completedRideModelFromJson(jsonString);

import 'dart:convert';

CompletedRideModel completedRideModelFromJson(String str) => CompletedRideModel.fromJson(json.decode(str));

String completedRideModelToJson(CompletedRideModel data) => json.encode(data.toJson());
...
class CompletedRideModel {
  ...
  factory CompletedRideModel.fromJson(Map<String, dynamic> json) => CompletedRideModel(
    status: json["status"],
