...
InProgressRideModel inProgressRideModelFromJson(String str) =>
    InProgressRideModel.fromJson(json.decode(str));

String inProgressRideModelToJson(InProgressRideModel data) =>
...
class InProgressRideModel {
  ...
  factory InProgressRideModel.fromJson(Map<String, dynamic> json) =>
      InProgressRideModel(
        status: json["status"],
