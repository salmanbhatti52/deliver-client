...
ScheduleBookingModel scheduleBookingModelFromJson(String str) => ScheduleBookingModel.fromJson(json.decode(str));

String scheduleBookingModelToJson(ScheduleBookingModel data) => json.encode(data.toJson());
...
class ScheduleBookingModel {
  ...
  factory ScheduleBookingModel.fromJson(Map<String, dynamic> json) => ScheduleBookingModel(
    status: json["status"],
