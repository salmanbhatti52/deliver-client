...
//
//     final cancelledRideModel = cancelledRideModelFromJson(jsonString);

import 'dart:convert';

CancelledRideModel cancelledRideModelFromJson(String str) => CancelledRideModel.fromJson(json.decode(str));

String cancelledRideModelToJson(CancelledRideModel data) => json.encode(data.toJson());

class CancelledRideModel {
  String? status;
  List<Datum>? data;
  ...
  factory CancelledRideModel.fromJson(Map<String, dynamic> json) => CancelledRideModel(
    status: json["status"],
