...
//
//     final rateRiderModel = rateRiderModelFromJson(jsonString);

import 'dart:convert';

RateRiderModel rateRiderModelFromJson(String str) => RateRiderModel.fromJson(json.decode(str));

String rateRiderModelToJson(RateRiderModel data) => json.encode(data.toJson());

class RateRiderModel {
  String? status;
  Data? data;
  ...
  factory RateRiderModel.fromJson(Map<String, dynamic> json) => RateRiderModel(
    status: json["status"],
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    bookingsRatingsId: json["bookings_ratings_id"],
  ...
  Map<String, dynamic> toJson() => {
    "bookings_ratings_id": bookingsRatingsId,
    "rated_by": ratedBy,
