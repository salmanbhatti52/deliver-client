...
CompletedRideModel completedRideModelFromJson(String str) =>
    CompletedRideModel.fromJson(json.decode(str));

String completedRideModelToJson(CompletedRideModel data) =>
...
class CompletedRideModel {
  ...
  factory CompletedRideModel.fromJson(Map<String, dynamic> json) =>
      CompletedRideModel(
        status: json["status"],
