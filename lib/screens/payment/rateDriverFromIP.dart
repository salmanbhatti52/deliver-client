...
class RateDriverFromIP extends StatefulWidget {
  final String? currentBookingId;
  final Map? riderData;
  final String? bookingDestinationId;

  const RateDriverFromIP({
    super.key,
    this.riderData,
  ...
  @override
  State<RateDriverFromIP> createState() => _RateDriverFromIPState();
}

class _RateDriverFromIPState extends State<RateDriverFromIP> {
  ...
  rateRider() async {
    try {
      ...
      debugPrint("fleetId: ${widget.riderData!['users_fleet_id'].toString()}");
      ...
      final response = await http.post(
        ...
        body: {
          ...
          "users_fleet_id": widget.riderData!['users_fleet_id'].toString(),
