...
class InProgressOffRoute extends StatefulWidget {
  ...
  @override
  State<InProgressOffRoute> createState() => _InProgressOffRouteState();
}

class _InProgressOffRouteState extends State<InProgressOffRoute> {
