...
//
//     final createProfileModel = createProfileModelFromJson(jsonString);

import 'dart:convert';

CreateProfileModel createProfileModelFromJson(String str) =>
    CreateProfileModel.fromJson(json.decode(str));

String createProfileModelToJson(CreateProfileModel data) =>
