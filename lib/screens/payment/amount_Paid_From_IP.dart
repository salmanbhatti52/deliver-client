...
class AmountPaidFromInProgress extends StatefulWidget {
  ...
  const AmountPaidFromInProgress({
    super.key,
    this.riderData,
    this.singleData,
    this.multipleData,
  ...
  @override
  State<AmountPaidFromInProgress> createState() =>
      _AmountPaidFromInProgressState();
}

class _AmountPaidFromInProgressState extends State<AmountPaidFromInProgress> {
  String? latDest;
  String? lngDest;
  double? destLat;
  double? destLng;
                            ...
                            onTap: () {
                              ...
                              if (widget.multipleData!['delivery_type'] ==
                                ...
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => ReceiptScreenSingleIP(
                                      singleData: widget.multipleData,
