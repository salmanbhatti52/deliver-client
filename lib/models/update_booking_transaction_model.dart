...
UpdateBookingTransactionModel updateBookingTransactionModelFromJson(String str) => UpdateBookingTransactionModel.fromJson(json.decode(str));

String updateBookingTransactionModelToJson(UpdateBookingTransactionModel data) => json.encode(data.toJson());
...
class UpdateBookingTransactionModel {
  ...
  factory UpdateBookingTransactionModel.fromJson(Map<String, dynamic> json) => UpdateBookingTransactionModel(
    status: json["status"],
