...
import 'package:deliver_client/screens/first_time_location_and_address/first_address_screen.dart';

String? userId;

class FirstSaveLocationScreen extends StatefulWidget {
  late double? location;
  FirstSaveLocationScreen({super.key, this.location});

  @override
  State<FirstSaveLocationScreen> createState() =>
      _FirstSaveLocationScreenState();
}

class _FirstSaveLocationScreenState extends State<FirstSaveLocationScreen> {
