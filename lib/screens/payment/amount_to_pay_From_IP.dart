...
class AmountToPayFromInProgress extends StatefulWidget {
  ...
  const AmountToPayFromInProgress({
    super.key,
    this.riderData,
    this.singleData,
    this.multipleData,
  ...
  @override
  State<AmountToPayFromInProgress> createState() =>
      _AmountToPayFromInProgressState();
}

class _AmountToPayFromInProgressState extends State<AmountToPayFromInProgress> {
  String? currencyUnit;
  ...
  updateBookingTransaction() async {
    try {
      ...
      debugPrint(
          "total_amount: ${widget.multipleData!.isNotEmpty ? widget.multipleData!['total_charges'] : widget.multipleData!['total_charges']}");
  ...
  void makePayment() async {
    ...
    if (response.status && response.reference == reference) {
      ...
      print("widget.multipleData: ${widget.multipleData}");
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => AmountPaidFromInProgress(
                        ...
                        children: [
                          ...
                          RichText(
                            ...
                            text: TextSpan(
                              children: [
                                ...
                                TextSpan(
                                  text: widget.multipleData!.isNotEmpty
                                      ? widget.multipleData!['total_charges']
                                      : widget.multipleData!['total_charges'],
                                  style: TextStyle(
                                    color: orangeColor,
                          ...
                          GestureDetector(
                            onTap: () async {
                              ...
                              //   }
                              // } else {
                              //   if (widget.multipleData!['bookings']
                              //           ["payment_gateways_id"] ==
                              //       '1') {
                              //     await updateBookingTransaction();
                              //     Navigator.push(
