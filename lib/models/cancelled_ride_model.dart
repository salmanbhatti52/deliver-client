...
CancelledRideModel cancelledRideModelFromJson(String str) =>
    CancelledRideModel.fromJson(json.decode(str));

String cancelledRideModelToJson(CancelledRideModel data) =>
...
class CancelledRideModel {
  ...
  factory CancelledRideModel.fromJson(Map<String, dynamic> json) =>
      CancelledRideModel(
        status: json["status"],
